 ...
 * @author Asus
 */
public class VendedoresFrame extends javax.swing.JFrame {
        ...
        if(!nombre.equals(null))
        {
            try{
                ...
                if (!nombreExists(con, nombre)){
                    PreparedStatement ps = con.prepareStatement("INSERT INTO vendedores (nombre,Activo) VALUES (?,?)");
                    ...
                    JOptionPane.showMessageDialog(null, "Ya existe una vendedor con este nombre");
                }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        if(!nombreMod.equals("")){
            try{
                ...
                PreparedStatement ps = con.prepareStatement("UPDATE vendedores SET nombre=? WHERE id_vendedor=?");
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        String nombre = nombreOb.toString();
            ...
            try{
                con = conexion.establecerConexion();
                int id = obtenerIdPorNombre(con, nombre);
                PreparedStatement ps = con.prepareStatement("UPDATE vendedores SET Activo=0 WHERE id_vendedor=?");
                ps.setInt(1, id);
                ps.executeUpdate();
    ...
    private boolean nombreExists(Connection con, String nombre) throws SQLException {
        String query = "SELECT COUNT(*) FROM vendedores WHERE nombre = ?";
    ...
    private void cargarDatos(){
        ...
        try{
            ...
            if (cbetapas != null){
                ps = con.prepareStatement("SELECT * FROM vendedores WHERE Activo = 1 ORDER BY nombre ASC");
                rs = ps.executeQuery();
                ...
                JOptionPane.showMessageDialog(null, "Error: cbvendedores is null");
            }
        }catch(SQLException e){
            JOptionPane.showMessageDialog(null, e.toString());
        }
    ...
    private int obtenerIdPorNombre(Connection con, String nombre) throws SQLException {
        ...
        String query = "SELECT id_vendedor FROM vendedores WHERE nombre = ?";
        try (PreparedStatement ps = con.prepareStatement(query)) {
            ps.setString(1, nombre);
            try (ResultSet rs = ps.executeQuery()) {
                if (rs.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendedoresFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendedoresFrame().setVisible(true);
            }
        });
    }
